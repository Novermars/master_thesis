...
public:
    ...
    CumulantMRTDynamicUBB( const shared_ptr<StructuredBlockForest> & blocks,
        ...
        :elementInitaliser(velocityCallback), pdfsID(pdfsID_)
    {
        ...
        indexVectorID = blocks->addStructuredBlockData< IndexVectors >( createIdxVector, "IndexField_CumulantMRTDynamicUBB");
    };
                            ...
                            FlagUID boundaryFlagUID, FlagUID domainFlagUID )
    {
        ...
        for( auto it = flagField->begin(); it != flagField->end(); ++it )
        {
            ...
            if ( isFlagSet( it.neighbor(0, 1, 0 , 0 ), boundaryFlag ) )
            {
                ...
                Vector3<real_t> InitialisatonAdditionalData = elementInitaliser(Cell(it.x(), it.y() + 1, it.z()), blocks, *block);
                element.vel_0 = InitialisatonAdditionalData[0];
                element.vel_1 = InitialisatonAdditionalData[1];
                element.vel_2 = InitialisatonAdditionalData[2];
                indexVectorAll.push_back( element );
            ...
            if ( isFlagSet( it.neighbor(-1, 0, 0 , 0 ), boundaryFlag ) )
            {
                ...
                Vector3<real_t> InitialisatonAdditionalData = elementInitaliser(Cell(it.x() - 1, it.y(), it.z()), blocks, *block);
                element.vel_0 = InitialisatonAdditionalData[0];
                element.vel_1 = InitialisatonAdditionalData[1];
                element.vel_2 = InitialisatonAdditionalData[2];
                indexVectorAll.push_back( element );
            ...
            if ( isFlagSet( it.neighbor(0, 0, 1 , 0 ), boundaryFlag ) )
            {
                ...
                Vector3<real_t> InitialisatonAdditionalData = elementInitaliser(Cell(it.x(), it.y(), it.z() + 1), blocks, *block);
                element.vel_0 = InitialisatonAdditionalData[0];
                element.vel_1 = InitialisatonAdditionalData[1];
                element.vel_2 = InitialisatonAdditionalData[2];
                indexVectorAll.push_back( element );
            ...
            if ( isFlagSet( it.neighbor(-1, 1, 0 , 0 ), boundaryFlag ) )
            {
                ...
                Vector3<real_t> InitialisatonAdditionalData = elementInitaliser(Cell(it.x() - 1, it.y() + 1, it.z()), blocks, *block);
                element.vel_0 = InitialisatonAdditionalData[0];
                element.vel_1 = InitialisatonAdditionalData[1];
                element.vel_2 = InitialisatonAdditionalData[2];
                indexVectorAll.push_back( element );
            ...
            if ( isFlagSet( it.neighbor(0, 1, 1 , 0 ), boundaryFlag ) )
            {
                ...
                Vector3<real_t> InitialisatonAdditionalData = elementInitaliser(Cell(it.x(), it.y() + 1, it.z() + 1), blocks, *block);
                element.vel_0 = InitialisatonAdditionalData[0];
                element.vel_1 = InitialisatonAdditionalData[1];
                element.vel_2 = InitialisatonAdditionalData[2];
                indexVectorAll.push_back( element );
            ...
            if ( isFlagSet( it.neighbor(-1, 0, 1 , 0 ), boundaryFlag ) )
            {
                ...
                Vector3<real_t> InitialisatonAdditionalData = elementInitaliser(Cell(it.x() - 1, it.y(), it.z() + 1), blocks, *block);
                element.vel_0 = InitialisatonAdditionalData[0];
                element.vel_1 = InitialisatonAdditionalData[1];
                element.vel_2 = InitialisatonAdditionalData[2];
                indexVectorAll.push_back( element );
