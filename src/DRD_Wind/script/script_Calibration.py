...
config = {
    ...
    'plt_tau'           :   True,
    'tol'               :   1.e-4, ### not important
    'lr'                :   1,     ### learning rate
    'penalty'           :   1.e0,
    'regularization'    :   1.e-5, ### NOTE: Experiment 1: 1.e-5, Experiment 2: 1.e-5
    'nepochs'           :   200, ### NOTE: Experiment 1: 200, Experiment 2: 100
    'curves'            :   [0,1,2,3],
    ...
    'noisy_data'        :   0.0, ### level of the data noise  ### NOTE: Experiment 1: 0.0, Experiment 2: 0.3
    'output_folder'     :   '/path/to/code/data/' ## NOTE: CHANGE PATH
}
